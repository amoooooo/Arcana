...
public class ImageSectionRenderer implements EntrySectionRenderer<ImageSection>{
	...
	public void render(PoseStack stack, ImageSection section, int pageIndex, int screenWidth, int screenHeight, int mouseX, int mouseY, boolean right, Player player){
		mc().getTextureManager().bindForSetup(section.getImage());
	...
	public void renderAfter(PoseStack stack, ImageSection section, int pageIndex, int screenWidth, int screenHeight, int mouseX, int mouseY, boolean right, Player player){
		// no-op
